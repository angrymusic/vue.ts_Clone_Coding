<script setup lang="ts">
  ...
  onMounted(async () => {
    await axios
      .post('http://localhost:8090/post', { img: props.img })
      .then((res) => {
        console.log(res);
...
<template>
  ...
  <div class="color-fafafa separator">
    <!-- 데스크탑 버전 -->
    <div class="desktop-flex row margin-side-auto border-solid-gray">
      <div class="col-7 img">
        <q-img :src="serverAddr + img"></q-img>
      </div>
      <div class="col-5 column bg-white">
        <div class="profile row">
          <q-avatar class="profile-img q-mt-xs">
            <q-img src="/src/assets/heongmin.jpg" />
          </q-avatar>
          <div class="column">
            <div class="name">hm_son7 ✔</div>
            <div class="location">Tottenham Hotspur Stadium</div>
          </div>
        </div>
        <div class="col comments separator">{{ title }}<br />{{ context }}</div>
        <div class="col-auto interaction separator row">
          <div class="like icon">
            <svg aria-label="좋아요" class="" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
              <path
          ...
          <div class="com icon">
            <svg aria-label="댓글 달기" class="" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
              <path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path>
            </svg>
          </div>
          <div class="dm icon">
            <svg aria-label="게시물 공유" class="" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
          ...
          <div class="bookmark icon">
            <svg aria-label="저장" class="-" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
    ...
    <div class="mobile-flex column">
      <div class="col profile row">
        ...
        <div class="col"></div>
        <div class="q-mt-xs">
          <svg aria-label="옵션 더 보기" class="" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
      ...
      <div class="col interaction separator row">
        <div class="like icon">
          <svg aria-label="좋아요" class="" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
            <path
              d="M16.792 3.904A4.989 4.989 0 0 1 21.5 9.122c0 3.072-2.652 4.959-5.197 7.222-2.512 2.243-3.865 3.469-4.303 3.752-.477-.309-2.143-1.823-4.303-3.752C5.141 14.072 2.5 12.167 2.5 9.122a4.989 4.989 0 0 1 4.708-5.218 4.21 4.21 0 0 1 3.675 1.941c.84 1.175.98 1.763 1.12 1.763s.278-.588 1.11-1.766a4.17 4.17 0 0 1 3.679-1.938m0-2a6.04 6.04 0 0 0-4.797 2.127 6.052 6.052 0 0 0-4.787-2.127A6.985 6.985 0 0 0 .5 9.122c0 3.61 2.55 5.827 5.015 7.97.283.246.569.494.853.747l1.027.918a44.998 44.998 0 0 0 3.518 3.018 2 2 0 0 0 2.174 0 45.263 45.263 0 0 0 3.626-3.115l.922-.824c.293-.26.59-.519.885-.774 2.334-2.025 4.98-4.32 4.98-7.94a6.985 6.985 0 0 0-6.708-7.218Z"
