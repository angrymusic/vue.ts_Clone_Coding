      ...
      <div class="desktop-flex col-12 row margin-bottom-40 justify-center">
        ...
        <div class="col-8 column">
          ...
          <div class="desktop bottom-desc col">
            <strong>Son HeungMin(손흥민)🇰🇷</strong><br />@spursofficial ⚽️🇰🇷🇬🇧 @adidasfootball <br /><a class="powerlink" href="https://www.facebook.com/HeungMinSonOfficial"
      ...
      <div class="mobile" style="width: 100%">
        ...
        <q-tabs switch-indicator v-model="tab" class="separator tabs color-fafafa text-black">
          <q-tab class="col-1" name="posts" label="">
            <svg aria-label="게시물" :class="{ selected: tab == 'posts' ? true : false }" color="#8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24">
          ...
          <q-tab class="col-1" name="reels" label=""
            ><svg aria-label="릴스" :class="{ selected: tab == 'reels' ? true : false }" color="#8e8e8e" fill="#8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24">
          ...
          <q-tab class="col-1" name="write" label="">
            <svg aria-label="글작성" :class="{ selected: tab == 'write' ? true : false }" color="#8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24">
              <path
      ...
      <div class="col-12 separator">
        ...
        <q-tab-panels v-model="tab" animated class="color-fafafa text-center">
          <q-tab-panel name="posts" class="row q-col-gutter-md">
            <Post v-for="(item, index) in imgList" :key="index" :title="item.title" :context="item.context" :img="item.img" @deletePost="deletePost" class="col-4"></Post>
          </q-tab-panel>
