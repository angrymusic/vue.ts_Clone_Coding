...
<template>
  <div class="instagram">
    ...
    <div class="q-pa-lg color-fafafa margin-padding-0 separator">
      <div class="row margin-bottom-40">
        ...
        <div class="col-8 column">
          <div class="top-desc col row q-gutter-sm margin-bottom-20">
            <div class="name row items-center">hm_son7 ✔</div>
            <div class="button row items-center">팔로우</div>
            <div class="button row items-center">메세지 보내기</div>
          </div>
          <div class="middle-desc col row q-col-gutter-lg margin-bottom-20">
