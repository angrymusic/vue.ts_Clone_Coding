<script setup lang="ts">
  ...
  window.addEventListener('resize', () => {
    if (q.screen.width > 1312 && q.screen.width > exSize) {
  ...
  const videoList: videoType[] = [
    ...
    },
    {
      ...
      name: '100만 유튜버',
      count: 1234,
      img: 'https://picsum.photos/500/300?t=0.28063436307045575g',
    },
  ];
</script>
<template>
  <q-layout class="no-shadow youtube">
    <q-header class="bg-white">
      <q-toolbar v-if="searchBar" class="row">
      ...
      <q-toolbar v-if="!searchBar" class="">
        ...
        <q-toolbar-title class="row items-center">
          ...
          <div class="voice-button button flex flex-center">
            <div class="icon">
              <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="">
          ...
          <div class="login-button row items-center border-gray">
            <svg viewBox="0 0 24 24" fill="rgb(6,95,212)" preserveAspectRatio="xMidYMid meet" focusable="false" class="icon" style="">
              <g class="style-scope yt-icon">
                <path
    ...
    <q-drawer :breakpoint="791" :overlay="false" class="absolute" show-if-above v-model="leftDrawerOpen" side="left" :width="240" :mini="miniOnOff">
      <div v-if="$q.screen.width < 791" class="height-50 row items-center">
      ...
      <q-list>
        <q-item clickable v-ripple>
          <q-item-section avatar>
            <img class="icon self-center" src="../assets/youtubehome.svg" />
        ...
        <q-item clickable v-ripple>
          <q-item-section avatar>
            <img class="icon self-center" src="../assets/youtubeshorts.svg" />
        ...
        <q-item clickable v-ripple>
          <q-item-section avatar>
            <img class="icon self-center" src="../assets/youtubesubscribe.svg" />
        ...
        <q-item clickable v-ripple>
          <q-item-section avatar>
            <img class="icon self-center" src="../assets/youtubedesk.svg" />
        ...
        <q-item clickable v-ripple>
          <q-item-section avatar>
            <img class="icon self-center" src="../assets/youtubehistory.svg" />
    ...
    <q-page-container>
      <div class="q-ml-lg q-mt-md">
        <div class="categories row">
          <div class="category" @click="selectCategory('all')">전체</div>
          <div class="category" @click="selectCategory('music')">음악</div>
          <div class="category" @click="selectCategory('game')">게임</div>
          <div class="category" @click="selectCategory('news')">뉴스</div>
        </div>
        <div class="row q-mt-xs" :class="{ 'q-col-gutter-xs': $q.screen.width < 1312, 'q-col-gutter-md': $q.screen.width >= 1312 }">
          <YoutubeVideo
            class="col-auto"
